...
/**
 * Edited by Samuel Filipe
 **/

// this code only will be used in external sources
public class MyApplication extends Application {
    ...
    public void LoadApk(String fileName) {
        ...
        if (getCacheDir() != null) {
            dexPath = this.getCacheDir() + "/" + S4J.GetApkName();
        } else {
            Toast.makeText(getApplicationContext(), "Cache is null", Toast.LENGTH_LONG).show();
        }
        ...
        try {
            ...
            Object layerP = new MyDexClassLoader(this, dexPath, cc.getCacheDir() + "/" + "files",
    ...
    protected void loadResources() throws InstantiationException, IllegalAccessException, IllegalArgumentException,
        ...
        mTheme.applyStyle(android.R.style.Theme_Light_NoTitleBar, true);
    }
